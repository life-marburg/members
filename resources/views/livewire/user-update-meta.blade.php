<x-form-section submit="update">
    ...
    <x-slot name="form">
        ...
        <!-- Instrument -->
        <div class="col-span-6 sm:col-span-4">
            <x-label for="instrument_groups" value="{{ __('Instrument Groups') }}"/>
            ...
            <x-input-error for="instrument_groups" class="mt-2"/>
        </div>

        <!-- Disable after days -->
        <div class="col-span-6 sm:col-span-4">
            <x-label for="disable-after-days" value="{{ __('Disable after inactivity') }}"/>
            ...
            <x-input-error for="disable-after-days" class="mt-2"/>
        </div>

        <!-- Admin -->
        <div class="col-span-6 sm:col-span-4">
            <x-label>
                <x-checkbox id="is_admin" wire:model="state.is_admin" class="mr-2"/>
                {{ __('Is Admin') }}
            </x-label>
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label>
                <x-checkbox id="can_view_all_instruments" wire:model="state.can_view_all_instruments" class="mr-2"
            ...
            <x-input-error for="can_view_all_instruments" class="mt-2"/>
        </div>
    </x-slot>
